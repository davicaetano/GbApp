...
public class GbEvent {
    ...
    @SerializedName("startDate") @Expose
    private String startDate;

    @SerializedName("objType") @Expose
    ...
    @SerializedName("loginRequired") @Expose
    ...
    public GbVenue getGbVenue() {
        return gbVenue;
    }

    public void setGbVenue(GbVenue gbVenue) {
        this.gbVenue = gbVenue;
    }
